...
익단속도 권장범위는 표 값을 노드로 **점도 로그축 선형보간**합니다. 계단으로
읽으면 1000 cP 는 2.5~5.0, 1001 cP 는 2.0~4.0 으로 1 cP 차이에 판정이 뒤집혀
점도 측정오차보다 민감해지기 때문입니다. 표에 적힌 점도에서는 표값과 정확히
일치하고 구간 안쪽만 부드럽게 변합니다. 형식·D/T·배플은 이산 선택이라
보간하지 않습니다.
